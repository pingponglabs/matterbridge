...
func (b *Binstagram) getRoomID(channel string) string {
return ""
}
...
func (b *Binstagram) getDisplayName(mxid string) string {
	return ""
}
...
func (b *Binstagram) cacheDisplayName(mxid string, displayName string) string {
	return ""
}
...
func (b *Binstagram) containsAttachment(content map[string]interface{}) bool {
	// Skip empty messages
...
func (b *Binstagram) getAvatarURL(sender string) string {
