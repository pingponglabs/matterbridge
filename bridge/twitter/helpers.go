...
func (b *Btwitter) getRoomID(channel string) string {
return ""
}
...
func (b *Btwitter) getDisplayName(mxid string) string {
	return ""
}
...
func (b *Btwitter) cacheDisplayName(mxid string, displayName string) string {
	return ""
}
...
func (b *Btwitter) containsAttachment(content map[string]interface{}) bool {
	// Skip empty messages
...
func (b *Btwitter) getAvatarURL(sender string) string {
